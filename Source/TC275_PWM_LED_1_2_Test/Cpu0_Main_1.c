...
int core0_main(void)
{
    ...
    while(1)
    {
        ...
        if( systick > SYSTICK_100MHZ/10 )   // 100ms
        {
            ...
            if( light_sensor > 3683 )
                light_sensor = 4095;
            else if( light_sensor < 2166 )
                light_sensor = 0;
            else
                light_sensor = ((light_sensor-2166)*4095)/(3683-2166);

            // FIXME:
            // red led duty = potential_meter/4095 * 12500
            // blue led duty = light_sensor_scaling/4095 * 12500
